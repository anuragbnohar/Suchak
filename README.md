...
role allows. What is kept back is everything that spends money — fetching,
Generate insights, Re-check alerts, Re-score — along with Settings, Policy,
the People roster, and adding or editing an entity. The refusal
